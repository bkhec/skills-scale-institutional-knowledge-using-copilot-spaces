...
OctoAcme projects may also involve **supporting roles** depending on project complexity: **UX Designers** design and validate user interfaces and experiences, collaborating with Product Managers and Developers. **DevOps Engineers** build, automate, and maintain delivery pipelines and infrastructure, partnering with Developers on deployment and CI/CD. **Data Analysts** define, collect, and analyze key metrics, complementing Product Managers in measuring outcomes and identifying improvements. **Customer Success** provides the voice of the customer during planning and review meetings, sharing feedback to support Product and Project Management. **Scrum Masters** (when using agile methodology) facilitate scrum events, remove blockers, and uphold agile principles across all team members. For detailed responsibilities and collaboration patterns, see [Roles and Personas](octoacme-roles-and-personas.md).
